...
checkpoint = ModelCheckpoint('/Users/sultm0a/Documents/Research/Cyclo_Stationary_ML/models/best_model_fc2_LV.h5', monitor='val_accuracy', save_best_only=True, mode='max', verbose=1)
...
best_model = load_model('/Users/sultm0a/Documents/Research/Cyclo_Stationary_ML/models/best_model_fc2_LV.h5')
...
# Get the bottleneck layer output for a specific input (for example, X_train_RYXA_scaled)
print(X_train_RYXA_scaled.shape)
print(X_test_RYXA_scaled.shape)
print(Y_train_RYXA_enc.shape)
